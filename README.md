...
El dataset utilizado fue el Swedish Leaf Dataset, con 15 especies de plantas.
...
Luego descomprímelo en tu ordenador y actualiza la variable `DATASET_PATH` en el código.
